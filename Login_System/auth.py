...
#     # FIXED: Changed from init(self) to __init__(self)
#     def __init__(self):
#         self.db = Database()
...
#         # FIXED: Removed 'not' so it triggers when the name IS empty
#         if self.validation.is_empty(name):
...
#         """
#         values = (name, email, mobile, username, password, question, answer)
...
#         # FIXED: Indented this line correctly so it sits inside the method
#         user = self.db.fetchone()
